...
os.system('wget https://leetcode.com/api/problems/algorithms/ -O problems.json')
...
os.system('python3 -m json.tool problems.json > problems.json.tmp')
os.system('mv problems.json.tmp problems.json')
